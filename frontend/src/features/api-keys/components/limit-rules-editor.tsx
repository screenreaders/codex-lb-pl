    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-muted-foreground">Zaawansowane</span>
          <Switch
            checked={advanced}
        ...
        <div className="space-y-2">
          ...
          {rules.length > 1 ? (
            <p className="text-xs text-muted-foreground">
              Wszystkie reguły są stosowane łącznie (AND). Żądanie jest blokowane po przekroczeniu dowolnego limitu.
            </p>
          ) : null}
        </div>
      )}
